...
function atelier_benji_scripts() {
	...
	wp_enqueue_style( 'atelier-benji-style', get_stylesheet_uri(), array(), '1.4.2' );
	wp_enqueue_style( 'atelier-benji-main', get_template_directory_uri() . '/assets/css/main.css', array( 'atelier-benji-style', 'atelier-benji-fonts' ), '1.4.2' );
	wp_enqueue_script( 'atelier-benji-main', get_template_directory_uri() . '/assets/js/main.js', array(), '1.4.2', true );
}
